...
class ClassSubjectAdmin(admin.ModelAdmin):
    list_display  = ['subject', 'academic_class', 'created_at']
    list_filter   = ['academic_class']
    search_fields = ['subject__name', 'academic_class__name']
    ordering      = ['academic_class', 'subject']

@admin.register(Chapter)
class ChapterAdmin(admin.ModelAdmin):
    list_display  = ['name', 'class_subject', 'order', 'is_completed', 'created_at']
    list_filter   = ['class_subject__academic_class', 'class_subject__subject', 'is_completed']
    search_fields = ['name', 'class_subject__subject__name']
...
class DoubtAdmin(admin.ModelAdmin):
    list_display  = ['student', 'class_subject', 'status', 'created_at']
    list_filter   = ['status', 'class_subject__academic_class']
