...
#     path('doubts/<int:doubt_id>/', DoubtDetailView.as_view(), name='doubt-detail'),
#     path('doubts/<int:doubt_id>/reply/', DoubtReplyCreateView.as_view(), name='doubt-reply'),
#      path('assigned-classes/', views_doubts.get_teacher_assigned_classes, name='teacher-assigned-classes'),
#     path('assigned-subjects/', views_doubts.get_teacher_assigned_subjects, name='teacher-assigned-subjects'),
    
#     # Doubts URLs
#     path('doubts/', views_doubts.get_teacher_doubts, name='teacher-doubts-list'),
#     path('doubts/<int:doubt_id>/reply/', views_doubts.reply_to_doubt, name='reply-to-doubt'),
# ]
