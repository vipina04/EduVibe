...
class TeacherAssignmentAdmin(admin.ModelAdmin):
    ...
    list_display = ('teacher_name', 'class_name', 'subject_name')
    list_filter = ('class_subject',)
    search_fields = ('teacher__email', 'teacher__first_name', 'class_subject__academic_class__name', 'class_subject__subject__name')
    ...
    def class_name(self, obj):
        return obj.class_subject.academic_class.name
...
class TestAdmin(admin.ModelAdmin):
    ...
    list_display = ('test_info', 'type_badge', 'marks', 'created_by_name', 'question_count')
    list_filter = ('type', 'chapter__class_subject', 'chapter__class_subject__academic_class')
    ...
    def test_info(self, obj):
        if obj.chapter:
            return f"{obj.chapter.class_subject.subject.name} - {obj.chapter.name}"
        return "General Test"
...
class AttendanceAdmin(admin.ModelAdmin):
    ...
    list_filter = ('is_present', 'date', 'class_subject')
    search_fields = ('student__email', 'student__first_name', 'class_subject__academic_class__name')
    date_hierarchy = 'date'
...
class AssignmentAdmin(admin.ModelAdmin):
    ...
    list_filter = ('chapter__class_subject', 'chapter__class_subject__academic_class')
...
class DoubtAdmin(admin.ModelAdmin):
    ...
    list_filter = ('class_subject', 'created_at')
    search_fields = ('text', 'student__email', 'class_subject__subject__name')
...
#     list_filter = ('type', 'chapter__subject', 'chapter__subject__academic_class')
#     search_fields = ('chapter__name', 'created_by__email')
#     inlines = [QuestionInline]
...
#     list_filter = ('chapter__subject', 'chapter__subject__academic_class')
#     search_fields = ('description', 'teacher__email', 'chapter__name')
