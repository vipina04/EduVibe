...
//   // Tests
//   getChapterTests: (chapterId) => api.get(`/students/chapters/${chapterId}/tests/`),
//   getAvailableTests: () => api.get('/students/available-tests/'),
//   startTest: (testId) => api.get(`/students/tests/${testId}/start/`),
//   submitTest: (testId, data) => api.post(`/students/tests/${testId}/submit/`, data),
...
//   submitAssignment: (assignmentId, data) => api.post(
...
//   markNotificationRead: (notificationId) => 
//     api.patch(`/students/notifications/${notificationId}/read/`),
// };

// // ============ TEACHER APIs ============
// export const teacherAPI = {
//   // Dashboard
//   // ✅ FIXED: backend registers /teachers/home/ not /teachers/dashboard/
//   getDashboard: () => api.get('/teachers/home/'),

//   // Classes & Subjects
//   // ✅ FIXED: correct backend URL is /teachers/classes/
//   getClasses: () => api.get('/teachers/classes/'),
//   // ✅ FIXED: returns subjects for teacher; accepts { class_id } param to filter by class
//   getSubjects: (params) => api.get('/teachers/subjects/', { params }),
//   // Class-specific subjects endpoint
//   getClassSubjects: (classId) => api.get(`/teachers/class/${classId}/subjects/`),
//   getMyClasses: () => api.get('/teachers/classes/'),
//   getMySubjects: () => api.get('/teachers/subjects/'),
//   getClassSubject: (classId, subjectId) => 
//     api.get(`/teachers/class/${classId}/subject/${subjectId}/`),
...
//   // Assignments
//   createAssignment: (data) => api.post('/teachers/assignments/create/', data),
//   getAssignments: () => api.get('/teachers/assignments/'),    // ✅ ADDED — was missing, caused TeacherAssignments.jsx crash
//   getMyAssignments: () => api.get('/teachers/assignments/'),  // alias kept for compatibility
//   getAssignmentSubmissions: (assignmentId) => 
//     api.get(`/teachers/assignments/${assignmentId}/submissions/`),
//   gradeSubmission: (submissionId, data) => 
//     api.post(`/teachers/submissions/${submissionId}/grade/`, data),
...
//   // Doubts
//   // ✅ FIXED: correct backend URLs are /teachers/doubts/ and /teachers/doubts/<id>/reply/
//   getDoubts: (params) => api.get('/teachers/doubts/', { params }),
//   replyToDoubt: (doubtId, formData) => api.post(`/teachers/doubts/${doubtId}/reply/`, formData),
//   replyDoubt: (doubtId, data) => api.post(`/teachers/doubts/${doubtId}/reply/`, data), // alias
...
// //   // Doubts - FIXED URLS (removed duplicate /api/ prefix)
// //   getClasses: async () => {
// //     const response = await api.get('/teachers/teacher-assigned-classes/');
...
// //     const response = await api.get('/teachers/teacher-assigned-subjects/');
// //     return response.data;
// //   },
...
// //   replyToDoubt: async (doubtId, formData) => {
// //     const response = await api.post(`/teachers/teacher-doubts/${doubtId}/reply/`, formData, {
// //       headers: {
...
// // //   // Doubts
// // //   getDoubts: () => api.get('/teachers/doubts/'),
// // //   replyDoubt: (doubtId, data) => api.post(`/teachers/doubts/${doubtId}/reply/`, data),
