...
const LoginPage = () => {
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-10">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-extrabold bg-gradient-to-r from-teal-500 to-cyan-500 bg-clip-text text-transparent">
              Login
            </h1>
          ...
          {/* Form Card */}
          <div className="backdrop-blur-2xl bg-white/70 dark:bg-black/40 border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/40 p-10 transition-all duration-300">
  ...
  <div className="relative my-4">
    ...
    <div className="relative flex justify-center">
      <span className="px-4 bg-slate-900 text-slate-500 text-sm">or continue with</span>
    </div>
  </div>
...
// import { useAuth } from '../context/AuthContext';
// import { HiMail, HiLockClosed, HiSun, HiMoon } from 'react-icons/hi';
// import { useTheme } from '../context/ThemeContext'; // Assuming this is your theme context
...
//     <div className={`min-h-screen transition-colors duration-300 ${
//       theme === 'dark' 
//         ? 'bg-gradient-to-b from-gray-950 via-indigo-950 to-purple-950' 
//         : 'bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100'
//     }`}>
//       {/* Transparent Navbar */}
//       <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/10 dark:bg-black/20 border-b border-white/10 dark:border-white/5">
//         <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
//           {/* Logo */}
//           <Link to="/" className="flex items-center space-x-3">
...
//           <button
//             onClick={toggleTheme}
//             className="p-2 rounded-full bg-white/20 dark:bg-black/30 hover:bg-white/30 dark:hover:bg-black/40 transition-all duration-200 backdrop-blur-sm border border-white/10"
//             aria-label="Toggle dark mode"
//           >
//             {theme === 'dark' ? (
//               <HiSun className="w-5 h-5 text-yellow-300" />
...
//           {/* Header */}
//           <div className="text-center">
//             <h1 className="text-5xl font-extrabold bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">
//               Welcome Back
//             </h1>
//             <p className="mt-3 text-lg text-gray-400 dark:text-gray-300">
//               Sign in to continue your learning journey
//             </p>
//           </div>

//           {/* Form Card */}
//           <div className="backdrop-blur-2xl bg-white/10 dark:bg-black/30 border border-white/10 dark:border-white/5 rounded-2xl shadow-2xl shadow-black/20 dark:shadow-black/40 p-10 transition-all duration-300">
//             <form className="space-y-8" onSubmit={handleSubmit}>
//               {/* Email Field */}
//               <div>
...
//                 </label>
//                 <div className="relative">
//                   <HiMail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 h-5 w-5" />
//                   <input
//                     id="email"
//                     name="email"
//                     type="email"
...
//                       errors.email 
//                         ? 'border-red-500 focus:ring-red-500' 
//                         : 'border-white/20 dark:border-white/10 focus:border-teal-500 focus:ring-teal-500'
//                     } bg-white/5 dark:bg-black/20 text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-200`}
//                     placeholder="you@example.com"
//                   />
//                 </div>
//                 {errors.email && (
...
//                 </label>
//                 <div className="relative">
//                   <HiLockClosed className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 h-5 w-5" />
//                   <input
//                     id="password"
//                     name="password"
//                     type="password"
...
//                 type="submit"
//                 disabled={isSubmitting}
//                 className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium text-lg shadow-lg hover:shadow-xl hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02]"
//               >
//                 {isSubmitting ? (
//                   <span className="flex items-center justify-center">
//                     <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
// //   return (
// //     <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-cyan-950 via-cyan-500 to-white-950 py-12 px-4 sm:px-6 lg:px-8">
